...
#else
    { Algorithm::INVALID,         "DERO",      "DERO_HE",      0,      0,              BLUE_BG_BOLD(WHITE_BOLD_S " dero    ") },
#endif

#if defined(XMRIG_ALGO_VERUSHASH)
    { Algorithm::VERUSHASH,       "VRSC",      "Verus",        0,      0,              BLUE_BG_BOLD(WHITE_BOLD_S " verus   ") },
#else
    { Algorithm::INVALID,         "VRSC",      "Verus",        0,      0,              BLUE_BG_BOLD(WHITE_BOLD_S " verus   ") },
#endif
};
