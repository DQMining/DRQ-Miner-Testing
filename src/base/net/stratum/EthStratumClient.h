...
private:
    ...
    static void writeVerusNonceHex(std::string &solution, uint32_t nonce);

    void authorize();
    void cacheVerusTemplate(const Job &job);
    const VerusTemplate *findVerusTemplate(const String &jobId) const;
    ...
    String m_nextTarget;
    String m_ntime;
    std::deque<VerusTemplate> m_verusTemplates;
