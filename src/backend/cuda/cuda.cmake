...
if (WITH_CUDA)
   ...
   if (WITH_VERUSHASH)
       list(APPEND HEADERS_BACKEND_CUDA src/backend/cuda/runners/CudaVerusHostRunner.h)
       list(APPEND SOURCES_BACKEND_CUDA src/backend/cuda/runners/CudaVerusHostRunner.cpp)
   endif()
else()
