...
template<>
size_t inline generate<Algorithm::VERUSHASH_FAMILY>(Threads<CudaThreads> &threads, const std::vector<CudaDevice> &devices)
{
    return generate(Algorithm::kVERUSHASH, threads, Algorithm::VERUSHASH, devices);
}
#endif
