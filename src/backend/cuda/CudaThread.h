...
public:
    ...
    /** Fixed blocks/threads for algorithms that do not query the CUDA plugin (e.g. host-side VerusHash). */
    CudaThread(uint32_t index, int32_t blocks, int32_t threads, int64_t affinity = -1);
